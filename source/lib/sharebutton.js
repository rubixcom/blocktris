			...
			<div id="' + WE + 'PopupWr">\
				<table id="' + WE + 'PopupTable" width="100%" height="100%" cellspacing="0" cellpadding="0"><tr style="background:none;"><td id="' + WE + 'PopupCell">\
					<div id="' + WE + 'Popup">\
						...
						<div id="' + WE + 'PopupLogoWr" style="margin-top:22px; margin-bottom:5px; text-align:center;">\
							<img src="//sharebutton.net/plugin/img/popup-logo.png" id="' + WE + 'PopupLogo" style="border:none; ">\
						</div>\
